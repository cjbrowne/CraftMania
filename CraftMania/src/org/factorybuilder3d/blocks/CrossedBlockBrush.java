...
public class CrossedBlockBrush extends BlockBrush
{
	...
	public void storeInVBO(FloatBuffer vbo, float x, float y, float z, LightBuffer lightBuffer)
	{
		...
		/* Blade 0 */
		ChunkMeshBuilder.put3f(vbo, x - 0.5f, y + 0.5f, z - 0.5f);
		ChunkMeshBuilder.putColorWithLight(vbo, ChunkMeshBuilder.COLOR_WHITE, light);
		ChunkMeshBuilder.put2f(vbo, _texturePosition.x(), _texturePosition.y());

		ChunkMeshBuilder.put3f(vbo, x + 0.5f, y + 0.5f, z + 0.5f);
		ChunkMeshBuilder.putColorWithLight(vbo, ChunkMeshBuilder.COLOR_WHITE, light);
		ChunkMeshBuilder.put2f(vbo, _texturePosition.x() + _textureSize.x(), _texturePosition.y());

		ChunkMeshBuilder.put3f(vbo, x + 0.5f, y - 0.5f, z + 0.5f);
		ChunkMeshBuilder.putColorWithLight(vbo, ChunkMeshBuilder.COLOR_WHITE, light);
		ChunkMeshBuilder.put2f(vbo, _texturePosition.x() + _textureSize.x(), _texturePosition.y() + _textureSize.y());

		ChunkMeshBuilder.put3f(vbo, x - 0.5f, y - 0.5f, z - 0.5f);
		ChunkMeshBuilder.putColorWithLight(vbo, ChunkMeshBuilder.COLOR_WHITE, light);
		ChunkMeshBuilder.put2f(vbo, _texturePosition.x(), _texturePosition.y() + _textureSize.y());
