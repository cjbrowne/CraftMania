 ...
 ******************************************************************************/
package org.factorybuilder3d.game;
...
import org.factorybuilder3d.blocks.BlockXMLLoader;
import org.factorybuilder3d.math.MathHelper;
import org.factorybuilder3d.math.Vec3f;
import org.factorybuilder3d.recipes.RecipeManager;
import org.factorybuilder3d.rendering.BufferManager;
import org.factorybuilder3d.rendering.GLFont;
import org.factorybuilder3d.world.World;
import org.factorybuilder3d.blocks.BlockManager;
import org.factorybuilder3d.items.ItemXMLLoader;
...
public class Game
{
	...
	private void renderOnScreenInfo()
	{
		...
		PerformanceMonitor.Operation[] ops = PerformanceMonitor.Operation.values();
	...
	public void startGameLoop()
	{
		...
		while (!Display.isCloseRequested() && !shouldQuitNextTick)
		{
			...
			/* Update */
			PerformanceMonitor.getInstance().start(PerformanceMonitor.Operation.UPDATE);
			update();
			PerformanceMonitor.getInstance().stop(PerformanceMonitor.Operation.UPDATE);
			
			/* Render */
			PerformanceMonitor.getInstance().start(PerformanceMonitor.Operation.RENDER_ALL);
			render();
			Display.update();
			PerformanceMonitor.getInstance().stop(PerformanceMonitor.Operation.RENDER_ALL);
